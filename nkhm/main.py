...
def main():
    ...
    if not st.session_state.nkhm_user:
        ...
        with col2:
            logo_url = "https://raw.githubusercontent.com/Cerdas-Bangsa-Ubelasy-NKHM-Nusantara/Aplikasi-Ubelasy-NKHM-Nusantara/fe55392b6f600c353b40436a6d02a4e98e3769c6/assets/nasionalisme1.jpg"
    ...
    with tab1:
        ...
        if not filtered:
            ...
            selected = st.radio("Pilih jawabanmu:", q['options'], key=f"radio_{q['text']}", index=None, disabled=st.session_state.nkhm_answered)
