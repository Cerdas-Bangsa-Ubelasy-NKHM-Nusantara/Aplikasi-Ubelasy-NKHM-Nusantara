...
def main():
    ...
    if not st.session_state.nkhm_user:
        ...
        with col2:
            logo_url = "https://github.com/Cerdas-Bangsa-Ubelasy-NKHM-Nusantara/Aplikasi-Ubelasy-NKHM-Nusantara/blob/af2362b6442cc193299b785655639264d6365144/assets/garuda_1.jpg"
