...
def safe_rerun():
    ...
    try:
        ...
        logging.warning(f"st.rerun gagal di stomata_tanggapan: {e}")
...
def load_soal_from_json(folder_name):
    ...
    try:
        ...
        logging.error(f"Error load_soal_from_json: {e}")
        return []
...
def get_random_soals():
    ...
    try:
        ...
        logging.error(f"Error dalam get_random_soals: {e}")
...
def init_tanggapan_state():
    ...
    try:
        ...
        logging.error(f"Error init_tanggapan_state: {e}")
...
def force_refresh_questions():
    ...
    try:
        ...
        logging.error(f"Error force_refresh_questions: {e}")
        st.error(f"Error refreshing soal: {e}")
...
def hide_results():
    ...
    try:
        ...
        logging.error(f"Error hide_results: {e}")
...
def hitung_total_skor_dari_jawaban(answers, soal_list):
    ...
    try:
        ...
        logging.error(f"Error hitung_total_skor_dari_jawaban: {e}")
        return 0
...
def tampilkan_hasil():
    ...
    try:
        ...
        logging.error(f"Error tampilkan_hasil: {e}")
...
def show_tanggapan():
    try:
        ...
        **Jawaban akan otomatis tersimpan** setiap kali Anda memilih opsi.
        ...
        logging.error(f"Error di show_tanggapan: {e}", exc_info=True)
        st.error(f"❌ Terjadi error di Stomata Hati - Tanggapan: {e}")
        st.exception(e)
